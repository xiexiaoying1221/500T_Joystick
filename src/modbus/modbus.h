...
int modbus_set_slave(modbus_t* ctx, int slave);//设置本机的从站地址
...
int modbus_read_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);//function code 3
int modbus_read_input_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);//function code 4
int modbus_write_bit(modbus_t *ctx, int coil_addr, int status);
int modbus_write_register(modbus_t *ctx, int reg_addr, int value);//function code 6
int modbus_write_bits(modbus_t *ctx, int addr, int nb, const uint8_t *data);
int modbus_write_registers(modbus_t *ctx, int addr, int nb, const uint16_t *data);//function code 16
